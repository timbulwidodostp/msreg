...
{phang2}{cmd:. msreg y x11 x12 (x21 x22 = z1 z2) using s2, vce(vi)}{p_end}

{pstd}
Specify 3 matches per observation{p_end}
{phang2}{cmd:. msreg y x11 x12 (x21 x22 = z1 z2) using s2, vce(vi) nneighbor(3)}{p_end}

{pstd}
Use the third order of polynomial in the power-series approximation{p_end}
{phang2}{cmd:. msreg y x11 x12 (x21 x22 = z1 z2) using s2, vce(vi) order(3)}{p_end}
